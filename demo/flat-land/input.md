...
description: A square is pulled out of his reality by a sphere, and shown the meaning of three dimensions.
identifier: "https://standardebooks.org/ebooks/edwin-a-abbott/flatland"
language: en-GB
...
source:
- "https://archive.org/details/flatlandromanceo1884abbo"
...
::: {#imprint.xhtml#imprint .section .imprint}
<div>

## Imprint

![The Standard Ebooks logo.](./logo.svg){.z3998:publisher-logo
...
Gutenberg](https://www.gutenberg.org/ebooks/201) and on digital scans
from the [Internet
Archive](https://archive.org/details/flatlandromanceo1884abbo).
...
For full license information, see the [Uncopyright](#uncopyright.xhtml)
...
::: {#dedication.xhtml#dedication .section .dedication}
To\
The Inhabitants of **space in general**\
And **`<abbr epub:type="z3998:given-name">`{=html}H. C.`</abbr>`{=html}
in particular**\
...
::: {#preface.xhtml#preface .section .preface}
<div>
...
it would not be visible, if it had not some thickness); and consequently
he ought (it is argued) to acknowledge that his countrymen are not only
long and broad, but also (though doubtless in a very slight degree)
*thick* or *high*. This objection is plausible, and, to Spacelanders,
almost irresistible, so that, I confess, when I first heard it, I knew
not what to reply. But my poor old friend's answer appears to me
completely to meet it.

"I admit," said he⁠---when I mentioned to him this objection⁠---"I admit
the truth of your critic's facts, but I deny his conclusions. It is true
...
once retort, 'Then measure it, or tell us in what direction it extends';
and this silences me, for I can do neither. Only yesterday, when the
Chief Circle (in other words our High Priest) came to inspect the state
prison and paid me his seventh annual visit, and when for the seventh
time he put me the question, 'Was I any better?' I tried to prove to him
that he was 'high,' as well as long and broad, although he did not know
it. But what was his reply? 'You say I am "high"; measure my "high-ness"
...
Fourth Dimension, which is not colour nor brightness nor anything of the
kind, but a true Dimension, although I cannot point out to you its
direction, nor can you possibly measure it.' What would you say to such
a visitor? Would not you have him locked up? Well, that is my fate: and
...
your Spaceland poets has said⁠---

> 'One touch of Nature makes all worlds
> akin.' "[1](#endnotes.xhtml#note-1){#preface.xhtml#noteref-1 .noteref}
...
and on the other hand, "It must needs be precisely thus, and we know all
about it."
:::
...
::: {#part-1.xhtml#part-1 .section .part}
<div>

```{=html}
<hgroup>
```
## [Part]{.label} [I]{.ordinal .z3998:roman}
...
`<abbr>`{=html}Fig.`</abbr>`{=html} 1 represents the tradesman as you
would see him while you were bending over him from above;
`<abbr>`{=html}figs.`</abbr>`{=html} 2 and 3 represent the tradesman, as
...
again.](./illustration-1.svg){#illustration-1 .z3998:illustration
.se:image.color-depth.black-on-transparent
epub:type="z3998:illustration se:image.color-depth.black-on-transparent"}
...
door.](./illustration-2.svg){#illustration-2 .z3998:illustration
.se:image.color-depth.black-on-transparent
epub:type="z3998:illustration se:image.color-depth.black-on-transparent"}
...
of an Isosceles
(`<abbr epub:type="z3998:initialism">`{=html}i.e.`</abbr>`{=html} a
...
3.  Any female, duly certified to be suffering from
    `<abbr>`{=html}St.`</abbr>`{=html} Vitus's Dance, fits, chronic cold
...
nearly the same, appearance, `<abbr>`{=html}viz.`</abbr>`{=html} that of
...
`<abbr epub:type="z3998:name-title">`{=html}Mr.`</abbr>`{=html} So-and-so"⁠---is
...
to feel
`<abbr epub:type="z3998:name-title">`{=html}Mr.`</abbr>`{=html} So-and-so";
...
"`<abbr epub:type="z3998:name-title">`{=html}Mr.`</abbr>`{=html} Smith,
permit me to feel
`<abbr epub:type="z3998:name-title">`{=html}Mr.`</abbr>`{=html} Jones."
...
triangle.](./illustration-3.svg){#illustration-3
.z3998:illustration .se:image.color-depth.black-on-transparent
epub:type="z3998:illustration se:image.color-depth.black-on-transparent"}
...
are next to me (`<abbr>`{=html}viz.`</abbr>`{=html} `CA`{.variable} and
...
`<abbr>`{=html}viz.`</abbr>`{=html} `D`{.variable} and `E`{.variable},
...
extremities, `<abbr>`{=html}viz.`</abbr>`{=html} `D′`{.variable} and
...
visible.](./illustration-4.svg){#illustration-4
.z3998:illustration .se:image.color-depth.black-on-transparent
epub:type="z3998:illustration se:image.color-depth.black-on-transparent"}
...
front half
(`<abbr epub:type="z3998:initialism">`{=html}i.e.`</abbr>`{=html} the
...
circle.](./illustration-5.svg){#illustration-5
.z3998:illustration .se:image.color-depth.black-on-transparent
epub:type="z3998:illustration se:image.color-depth.black-on-transparent"}
...
::: {#part-2.xhtml#part-2 .section .part}
<div>

```{=html}
<hgroup>
```
## [Part]{.label} [II]{.ordinal .z3998:roman}
...
directions.](./illustration-6.svg){#illustration-6
.z3998:illustration .se:image.color-depth.black-on-transparent
epub:type="z3998:illustration se:image.color-depth.black-on-transparent"}
...
One, `<abbr>`{=html}viz.`</abbr>`{=html} the bass and tenor of the man
...
disappeared.](./illustration-7.svg){#illustration-7
.z3998:illustration .se:image.color-depth.black-on-transparent
epub:type="z3998:illustration se:image.color-depth.black-on-transparent"}
...
`<abbr>`{=html}viz.`</abbr>`{=html}, length and breadth (or thickness).
...
intersection.](./illustration-8.svg){#illustration-8
.z3998:illustration .se:image.color-depth.black-on-transparent
epub:type="z3998:illustration se:image.color-depth.black-on-transparent"}
...
**Sphere.** Tell me,
`<abbr epub:type="z3998:name-title">`{=html}Mr.`</abbr>`{=html} Mathematician;
...
marked.](./illustration-9.svg){#illustration-9
.z3998:illustration .se:image.color-depth.black-on-transparent
epub:type="z3998:illustration se:image.color-depth.black-on-transparent"}
...
composition.](./illustration-10.svg){#illustration-10
.z3998:illustration .se:image.color-depth.black-on-transparent
epub:type="z3998:illustration se:image.color-depth.black-on-transparent"}
...
::: {#endnotes.xhtml#endnotes .section .endnotes}
## Endnotes

1.  ::: {#endnotes.xhtml#note-1}
    ...
    with the Sphere, certain remarks which have a bearing on the point
    in question, and which he had previously omitted as being tedious
    and unnecessary. [↩](#preface.xhtml#noteref-1){.backlink}
    :::

2.  ::: {#endnotes.xhtml#note-2}
    "What need of a certificate?" a Spaceland critic may ask: "Is not
    ...
    any position will marry an uncertified Triangle. Square offspring
    ...
    [↩](#chapter-3.xhtml#noteref-2){.backlink}
    :::

3.  ::: {#endnotes.xhtml#note-3}
    ...
    `<abbr>`{=html}Sept.`</abbr>`{=html} 1884,
    `<abbr>`{=html}p.`</abbr>`{=html} 1255) that they may "approach in a
    becoming and respectful manner."
    [↩](#chapter-4.xhtml#noteref-3){.backlink}
    :::

4.  ::: {#endnotes.xhtml#note-4}
    When I say "sitting," of course I do not mean any change of attitude
    ...
    states of volition implied in "lying," "sitting," and "standing,"
    ...
    to dwell. [↩](#chapter-15.xhtml#noteref-4){.backlink}
    :::
:::
...
1.  [A diagram of three triangles, points downwards. They all have the
    same width, but the second has a smaller height than the first, and
    the third has a smaller height
    again.](#chapter-1.xhtml#illustration-1)

2.  [A map of a pentagonal house. The corners are marked `A`{.variable},
    `B`{.variable}, `R`{.variable}, `O`{.variable} and `F`{.variable}.
    The edge between `R`{.variable} and `A`{.variable} has the men's
    door, and the edge between `F`{.variable} and `B`{.variable} has a
    smaller women's door.](#chapter-2.xhtml#illustration-2)

3.  [A diagram showing two shapes and views onto them. The first shape,
    an equilateral triangle has the near corner to the point of view
    labelled `A`{.variable} and the furthest visible points labelled
    `B`{.variable} and `C`{.variable}. Points `D`{.variable} and
    `E`{.variable} are level with point `A`{.variable} and sit on the
    lines of sight from the point of view to corners `B`{.variable} and
    `C`{.variable}. The second shape is a regular pentagon and has the
    same points marked (with prime marks) to show that the outside
    visible points are closer to the point of view than with the
    triangle.](#chapter-6.xhtml#illustration-3)

4.  [A diagram showing the lines of sight from a position on the right
    hand side of a hexagon, aligned to have points up and down. The
    labelled points on the hexagon are `A`{.variable} and `B`{.variable}
    on the side visible to the viewpoint, and `C`{.variable} and
    `D`{.variable} which show the extent of the hexagon that is
    visible.](#chapter-6.xhtml#illustration-4)

5.  [A diagram showing the lines of sight from a position on the right
    hand side of a circle on the left. The labelled points on the circle
    are `M`{.variable} at the top, `A`{.variable} on the left directly
    opposite the point of view, `B`{.variable} on the right nearest the
    point of view, and `C`{.variable} and `D`{.variable} which describe
    the visible portion of the front of the
    circle.](#chapter-9.xhtml#illustration-5)

6.  [A diagram titled "My view of Lineland." It shows the narrator
    looking down on an axis, along which can be found women (dots), boys
    (small dashes), men (longer dashes) and in the middle the king who,
    being on the line, can only see a point in both
    directions.](#chapter-13.xhtml#illustration-6)

7.  [A diagram showing Lineland, with the King's position on the right,
    and in the middle the narrator's body just before they
    disappeared.](#chapter-14.xhtml#illustration-7)

8.  [A diagram showing three states of the Sphere's intersection with a
    point of view. This first shows the Sphere with his section at full
    size, the second shows the Sphere rising with a smaller
    intersection, and the third the Sphere at the point of vanishing
    with a tiny intersection.](#chapter-16.xhtml#illustration-8)

9.  [A map of the house, with the locations of rooms and inhabitants
    marked.](#chapter-18.xhtml#illustration-9)

10. [A diagram showing two cubes similar in size and aspect; the first
    is composed from stacked squares, the second is drawn with no guide
    to its composition.](#chapter-19.xhtml#illustration-10)
...
::: {#colophon.xhtml#colophon .section .colophon}
<div>
...
*Flatland*\
was published in `<time>`{=html}1884`</time>`{=html} by\
[Edwin A. Abbott](https://en.wikipedia.org/wiki/Edwin_A._Abbott).

This ebook was produced for\
[Standard Ebooks](https://standardebooks.org/)\
by\
[Robin Whittleton](http://www.robinwhittleton.com/),\
and is based on a transcription produced in
`<time>`{=html}1995`</time>`{=html} for\
...
*Rotterdam*,\
a painting completed in `<time>`{=html}1914`</time>`{=html} by\
[Edward Wadsworth](https://en.wikipedia.org/wiki/Edward_Wadsworth).\
The cover and title pages feature the\
**League Spartan** and **Sorts Mill Goudy**\
typefaces created in `<time>`{=html}2014`</time>`{=html} and
`<time>`{=html}2009`</time>`{=html} by\
[The League of Moveable Type](https://www.theleagueofmoveabletype.com/).

This edition was released on\
**`<time datetime="2025-12-01T01:45:04Z">`{=html}December 1, 2025,
1:45 `<abbr class="eoc">`{=html}a.m.`</abbr>`{=html}`</time>`{=html}**\
and is based on\
**revision e6f6864**.\
The first edition of this ebook was released on\
`<time datetime="2018-01-04T23:03:45Z">`{=html}January 4, 2018,
11:03 `<abbr class="eoc">`{=html}p.m.`</abbr>`{=html}`</time>`{=html}\
You can check for updates to this ebook, view its revision history, or
download it for different ereading systems at\
[standardebooks.org/ebooks/edwin-a-abbott/flatland](https://standardebooks.org/ebooks/edwin-a-abbott/flatland).
...
::: {#uncopyright.xhtml#uncopyright .section .copyright-page}
## Uncopyright
